...
base.url <- 'http://pokeapi.co/api/v2/pokemon/'
...
pokemon.url <- paste0(base.url,name)
print(pokemon.url)
...
move.names <- poke.moves %>% select(move.name)
